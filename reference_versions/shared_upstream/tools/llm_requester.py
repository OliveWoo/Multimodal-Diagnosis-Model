...
PROMPT_REGISTRY: dict[str, Path] = {
    ...
    "underlying": REPO_ROOT / "prompts" / "underlying_prompt.txt",
    # agents/prompts/
    "big_summary": REPO_ROOT / "agents" / "prompts" / "big_prompt.txt",
    "underlying_agent": REPO_ROOT / "agents" / "prompts" / "underlying_agent_prompt.txt",
    "cbc_other_lab_agent": REPO_ROOT / "agents" / "prompts" / "CBC_otherLab_prompt.txt",
    ...
    # "mngs_big_agent": REPO_ROOT / "agents" / "prompts" / "mNGS_big_prompt.txt",
    "mngs_max_agent": REPO_ROOT / "agents" / "prompts" / "mNGS_max_prompt.txt",
    "mngs_max_agent_no_filmarray": REPO_ROOT
    / "agents"
    / "prompts"
    / "mNGS_max_prompt_no_filmarray.txt",
