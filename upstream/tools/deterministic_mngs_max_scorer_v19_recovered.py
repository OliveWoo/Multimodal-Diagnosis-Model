...
RANKED_RULE_VERSION = "mngs_deterministic_level_only_v19_low_specificity_taxonomy"
...
def score_candidate(
    ...
    if typical_pneumonia_hospital_mngs_rule(candidate):
        candidate["mngs_signal_tier"] = "M2_moderate"
        candidate["module_support_summary"]["mNGS"] = "M2_moderate"
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--summary-mode",
        choices=["deterministic", "full", "no_filmarray"],
